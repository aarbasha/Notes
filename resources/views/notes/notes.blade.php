    ...
    <div class="container mt-5">
        ...
        <div class="app">
            <div class="row d-flex justify-content-center">
                <div class="col-lg-2">
                    <a class="btn btn-primary btn-lg" href="{{ route('pages.index') }}"> Pages </a>
                </div>
                <div class="col-lg-10 d-flex justify-content-center">
                    <p class="text-center h1 text-success" style="">
                        {{__("Page Title")}} :  {{ $page->title }}
                    </p>
                </div>
            </div>
                    ...
                    <div class="pages col-xl-6 col-lg-12 col-md-12">
                        <div class="card-page">
                            ...
                            <div class="card-body">
                                ...
                                @include('notes.model_delete')
                                @include('notes.model_edit')
                            </div>
                        </div>
                    </div>
                @endforeach
