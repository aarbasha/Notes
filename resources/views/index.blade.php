        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1"
                    ...
                    <h1>{{ __('Notes Management')}}</h1>
                    <h2>{{__('Manage your notes professionally - Project Web3')}}</h2>

                    <div class="row">
                        <div class="col-md-12">
                            <a href="/home" class="btn-get-started scrollto">{{__('Get Started')}}</a>
                            @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                <a rel="alternate" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}" class="btn-get-started m-2 scrollto">
                                    {{ $properties['native'] }}
                                </a>
                            @endforeach
                             <a href="https://www.youtube.com/watch?v=uIBp-eN4Ph4" class=" mt-3 glightbox btn-watch-video"><i
